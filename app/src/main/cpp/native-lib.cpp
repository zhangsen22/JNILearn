...
Java_com_example_nativecdemo_TestJNIBean_testLogInJNI(JNIEnv *env, jclass type) {
    LOGE("my name is %s\n", "aserbao");//简约型
    __android_log_print(ANDROID_LOG_INFO, "android", "my name is %s\n", "aserbao"); //log i类型
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_example_nativecdemo_TestJNIBean_carNameFromJNI(
        JNIEnv* env,
        jobject obj) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_nativecdemo_TestJNIBean_showCardFromJNI(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_nativecdemo_CarJNI_test(JNIEnv *env, jobject instance) {
    jclass carClass = env->GetObjectClass(instance);
...
Java_com_example_nativecdemo_TestJNIBean_testNewJavaDate(JNIEnv *env, jobject instance) {
...
Java_com_example_nativecdemo_TestJNIBean_testNewStaticRandomParam(JNIEnv *env, jclass type,
                                                                 jint random) {
    jmethodID jmethodID1 = env ->GetStaticMethodID(type,"getRandom","(I)I");
    jint  result = env ->CallStaticIntMethod(type,jmethodID1,100);
    return result;
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_example_nativecdemo_TestJNIBean_testNewRandomParam(JNIEnv *env, jobject instance, jint random) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_nativecdemo_TestJNIBean_testChangeField(JNIEnv *env, jobject instance) {
...
Java_com_example_nativecdemo_TestJNIBean_testCallFatherMethod(JNIEnv *env, jobject instance) {
    jclass clazz = env -> GetObjectClass(instance);
    jfieldID  father_field = env -> GetFieldID(clazz,"father","Lcom/example/nativecdemo/Father;");
    jobject  mFather = env -> GetObjectField(instance,father_field);
    jclass  clazz_father = env -> FindClass("com/example/nativecdemo/Father");
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_nativecdemo_TestJNIBean_testCallChildMethod(JNIEnv *env, jobject instance) {
    jclass clazz = env -> GetObjectClass(instance);
    jfieldID  father_field = env -> GetFieldID(clazz,"father","Lcom/example/nativecdemo/Father;");
    jobject  mFather = env -> GetObjectField(instance,father_field);
    jclass  clazz_father = env -> FindClass("com/example/nativecdemo/Father");
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_nativecdemo_TestJNIBean_testCallMethod(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_nativecdemo_TestJNIBean_testStaticCallMethod(JNIEnv *env, jclass type) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_nativecdemo_TestJNIBean_testStaticCallStaticMethod(JNIEnv *env, jclass type) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_nativecdemo_TestJNIBean_testNewString(JNIEnv *env, jclass type) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_nativecdemo_TestJNIBean_testNewStringUTF(JNIEnv *env, jclass type) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_nativecdemo_TestJNIBean_testStringLength(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_nativecdemo_TestJNIBean_testGetStringRegion(JNIEnv *env, jclass type,
                                                            jstring inputString_) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_nativecdemo_TestJNIBean_testGetStringUTFRegion(JNIEnv *env, jclass type,
                                                               jstring inputString_) {
    jint length = env -> GetStringUTFLength(inputString_);
    jint half = length /2;
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_nativecdemo_TestJNIBean_testChangeString(JNIEnv *env, jclass type,
                                                         jstring inputString_) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_nativecdemo_TestJNIBean_testCallMethodParamList2(JNIEnv *env, jobject instance, jint num,
                                                 jstring str_, jint num2) {
    //获取java传递的参数
    const char *strCont = env->GetStringUTFChars(str_, 0);
    //通过反射获取java类
    jclass ccallj = env->FindClass("com/example/nativecdemo/TestJNIBean");
    //实例化该类
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_nativecdemo_TestJNIBean_testCallMethodParamList(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_nativecdemo_TestJNIBean_testGetTArrayElement(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_nativecdemo_TestJNIBean_testThrowException(JNIEnv *env, jobject instance) {
...
/*
 * Class:     com_example_nativecdemo_Car
 * Method:    getCarName
